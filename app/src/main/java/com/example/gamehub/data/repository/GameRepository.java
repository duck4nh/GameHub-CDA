...
/**
 * Single data access facade for the app.
 *
 * This repository hides Room, asset import, Firebase, and WorkManager details
 * behind simple methods used by activities, fragments, and view models.
 */
public class GameRepository {
    ...
    /**
     * Ensures quiz questions and Memory levels exist locally before gameplay.
     * Quiz rows are imported from the packaged asset DB, while Memory levels are
     * generated by DatabaseSeeder.
     */
    ...
    /**
     * Returns filtered quiz questions for a new session.
     */
    ...
    /**
     * Returns all Memory levels with unlock and best-time metadata.
     */
    ...
    /**
     * Updates local best-time and unlock state after a Memory win.
     */
    ...
    /**
     * Persists one round into Local_History and schedules background sync if the
    ...
    /**
     * Enqueues WorkManager sync only when there are unsynced rows.
     */
    ...
    /**
     * Pushes pending Local_History rows to Firebase one by one and returns a
     * summary message for UI to display.
     */
